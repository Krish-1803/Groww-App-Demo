...
// the About sheet. The app opens straight on Home; the quiz is an on-demand
// overlay (opened from the Home prompt or when the user tries to invest).
...
import { OnboardingOverlay } from './screens/Onboarding'
    ...
    <PhoneFrame>
      ...
      <ScrollArea>
        <Routes>
          ...
          <Route path="/community" element={genZ ? <Community /> : <Navigate to="/" replace />} />
